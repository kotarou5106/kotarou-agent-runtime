...
from agent_runtime.policies.delegation import DelegationPolicy
from agent_runtime.tool_bundles import build_readonly_research_tools
from agent_runtime.tools.base import Tool
from agent_runtime.tools.meta import register_common_meta_tools
from agent_runtime.tools.message_push import MessagePushTool
from agent_runtime.tools.registry import ToolRegistry
from agent_runtime.tools.spawn import SpawnManageTool, SpawnTool
...
class CommonMetaToolsetProvider(ToolsetProvider):
    ...
    def register(self, registry: ToolRegistry, deps: ToolsetDeps):
        ...
        if deps.vl_provider is not None and deps.vl_model:
            from agent_runtime.tools.vision import ReadImageVisionTool
