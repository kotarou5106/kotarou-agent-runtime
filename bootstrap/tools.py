...
from agent_runtime.config_models import Config, WiringConfig
from agent_runtime.context import ContextBuilder
from agent_runtime.peer_agent.process_manager import PeerProcessManager
from agent_runtime.peer_agent.poller import PeerAgentPoller
from agent_runtime.peer_agent.registry import PeerAgentRegistry
from agent_runtime.looping.core import AgentLoop
from agent_runtime.looping.ports import (
    AgentLoopConfig,
    AgentLoopDeps,
    LLMConfig,
    LLMServices,
...
from agent_runtime.mcp.registry import McpServerRegistry
from agent_runtime.provider import LLMProvider
from agent_runtime.retrieval.default_pipeline import DefaultMemoryRetrievalPipeline
from agent_runtime.retrieval.knowledge_pipeline import DefaultKnowledgeRetrievalPipeline
from agent_runtime.scheduler import SchedulerService
from agent_runtime.tools.message_push import MessagePushTool
from agent_runtime.tools.registry import ToolRegistry
from agent_runtime.turns.outbound import BusOutboundPort
...
from agent_runtime.core.memory.markdown import MemoryLifecycleBindRequest, MarkdownMemoryMaintenance
from agent_runtime.core.memory.runtime import MemoryRuntime
from agent_runtime.core.net.http import SharedHttpResources
from knowledge_system.config import KnowledgeConfig as KnowledgeSystemConfig
from knowledge_system.service import KnowledgeService
from memory_system.embedder import Embedder
from proactive_system.presence import PresenceStore
from storage.sessions.manager import Session, SessionManager
...
class CoreRuntime:
    ...
    async def inspect_modules(self) -> str:
        ...
        from agent_runtime.lifecycle.phase import inspect_phase
        from agent_runtime.lifecycle.phases.after_reasoning import (
            default_after_reasoning_modules,
        )
        from agent_runtime.lifecycle.phases.after_step import default_after_step_modules
        from agent_runtime.lifecycle.phases.after_turn import default_after_turn_modules
        from agent_runtime.lifecycle.phases.before_reasoning import (
            default_before_reasoning_modules,
        )
        from agent_runtime.lifecycle.phases.before_step import default_before_step_modules
        from agent_runtime.lifecycle.phases.before_turn import default_before_turn_modules
        from agent_runtime.lifecycle.phases.prompt_render import default_prompt_render_modules
...
def _build_loop_deps(
    *,
    ...
    knowledge_retrieval_pipeline = None
    ...
    return AgentLoopDeps(
        ...
        knowledge_retrieval_pipeline=knowledge_retrieval_pipeline,
        context=context,
...
def build_core_runtime(
    ...
    from agent_runtime.plugins.manager import PluginManager as _PluginManager
