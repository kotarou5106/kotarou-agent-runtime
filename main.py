...
from dashboard.backend.api import run_dashboard_api
...
def _default_workspace() -> Path:
    return Path.home() / ".kotarou" / "workspace"
...
def connect_cli(config_path: str = "config.toml") -> None:
    ...
    try:
        from connectors.channels.cli_tui import run_tui
    except RuntimeError as exc:
        print(exc)
        print("回退到纯文本 CLI。")
        from connectors.channels.cli import CLIClient
