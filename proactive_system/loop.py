...
if TYPE_CHECKING:
    from agent_runtime.core.memory.engine import MemoryRetrievalApi
...
from agent_runtime.turns.outbound import PushToolOutboundPort
from agent_runtime.turns.orchestrator import TurnOrchestrator, TurnOrchestratorDeps
from agent_runtime.core.common.strategy_trace import build_strategy_trace_envelope
from proactive_system.anyaction import AnyActionGate, QuotaStore
from proactive_system.energy import (
    compute_energy,
    d_energy,
    next_tick_from_score,
)
from proactive_system.judge import MessageDeduper
from proactive_system.config import ProactiveConfig
from proactive_system.memory_sampler import sample_memory_chunks
from proactive_system.presence import PresenceStore
from proactive_system.sensor import Sensor
...
"""
    ...
    def _build_fitbit_provider(self):
        if not self._fitbit_enabled:
            return None
        from proactive_system.fitbit_sleep import FitbitSleepProvider
