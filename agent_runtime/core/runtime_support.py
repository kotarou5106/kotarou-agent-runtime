...
from agent_runtime.lifecycle.types import PromptRenderInput, PromptRenderResult

logger = logging.getLogger("agent_runtime.tool_discovery")
...
class ToolDiscoveryState:
    ...
    def unlock_from_result(self, result_json: str) -> set[str]:
        ...
        lived in agent_runtime/core/reasoner.py. Pure parsing — no mutation of external
