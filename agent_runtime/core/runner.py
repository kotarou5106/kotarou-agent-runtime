...
from agent_runtime.looping.handlers import process_spawn_completion_event
...
if TYPE_CHECKING:
    from agent_runtime.core.passive_turn import AgentCore
    from agent_runtime.core.runtime_support import AgentLoopRunner, PromptRenderRunner
