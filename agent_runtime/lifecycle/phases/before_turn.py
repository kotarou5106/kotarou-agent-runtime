...
from agent_runtime.core.runtime_support import SessionLike
...
from agent_runtime.lifecycle.types import BeforeTurnCtx, TurnState
...
class _BuildBeforeTurnCtxModule:
    ...
    async def run(self, frame: BeforeTurnFrame) -> BeforeTurnFrame:
        ...
        frame.slots[_CTX_SLOT] = BeforeTurnCtx(
            ...
            knowledge_context_block=bundle.knowledge_context_block,
            knowledge_citations=list(bundle.knowledge_citations),
            knowledge_retrieval_trace=dict(bundle.knowledge_retrieval_trace),
