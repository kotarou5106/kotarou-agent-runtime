...
from agent_runtime.lifecycle.types import PromptRenderCtx, PromptRenderInput, PromptRenderResult
...
class _BuildPromptRenderCtxModule:
    ...
    async def run(self, frame: PromptRenderFrame) -> PromptRenderFrame:
        ...
        frame.slots[_CTX_SLOT] = PromptRenderCtx(
            ...
            knowledge_context_block=input.knowledge_context_block,
            knowledge_citations=list(input.knowledge_citations),
            knowledge_retrieval_trace=dict(input.knowledge_retrieval_trace),
    ...
    async def run(self, frame: PromptRenderFrame) -> PromptRenderFrame:
        ...
        rendered = self._context.render(
            ContextRequest(
                ...
                knowledge_context_block=ctx.knowledge_context_block,
