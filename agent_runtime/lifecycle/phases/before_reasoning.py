...
from agent_runtime.lifecycle.types import BeforeReasoningCtx, BeforeReasoningInput
...
class _BuildBeforeReasoningCtxModule:
    ...
    async def run(self, frame: BeforeReasoningFrame) -> BeforeReasoningFrame:
        ...
        frame.slots[_CTX_SLOT] = BeforeReasoningCtx(
            ...
            knowledge_context_block=before_turn.knowledge_context_block,
            knowledge_citations=list(before_turn.knowledge_citations),
            knowledge_retrieval_trace=dict(before_turn.knowledge_retrieval_trace),
