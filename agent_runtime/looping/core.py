...
from agent_runtime.looping.interrupt import InterruptResult, TurnInterruptState
from agent_runtime.core.runner import CoreRunner, CoreRunnerDeps
...
# Re-export for backward-compat: existing callers import these from agent_runtime.core.py
__all__ = [
    "AgentLoop",
]
from agent_runtime.events.event_bus import EventBus
from agent_runtime.events.events import (
    InboundItem,
    InboundMessage,
    OutboundMessage,
    SpawnCompletionItem,
...
class AgentLoop:
    ...
    def _assemble_passive_runtime(
        ...
        *,
        ...
        passive_context_store = DefaultContextStore(
            ...
            context=self._context,
            knowledge_retrieval=deps.knowledge_retrieval_pipeline,
    ...
    async def _run_agent_loop(
        ...
        from agent_runtime.core.passive_turn import build_turn_injection_prompt
    ...
    async def trigger_memory_consolidation(
        ...
        *,
        ...
        from agent_runtime.core.memory.markdown import ConsolidateRequest
