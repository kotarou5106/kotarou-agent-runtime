...
if TYPE_CHECKING:
    from agent_runtime.core.types import ToolCallGroup
...
class TraceReplayEvent:
    ...
    event_type: str
    title: str
    payload: dict[str, Any] = field(default_factory=_empty_metadata)
    timestamp: datetime | None = None
    source: Literal["passive", "proactive", "drift"] = "passive"
