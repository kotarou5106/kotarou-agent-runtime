...
from agent_runtime.provider import LLMProvider, LLMResponse
from agent_runtime.skills import SkillsLoader
...
from agent_runtime.core.memory.utils import (
...
from memory_system.post_response_worker import PostResponseMemoryWorker
from memory_system.procedure_tagger import ProcedureTagger
from memory_system.query_builder import build_procedure_queries
from memory_system.retriever import Retriever
from memory_system.rule_schema import build_procedure_rule_schema
...
class DefaultMemoryEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._wire_memory_system_events()
    ...
    def _wire_memory_system_events(self) -> None:
    ...
    # 对话提交后只入队，不在主回复链路里等待 memory_system 后处理。
