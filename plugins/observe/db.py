...
CREATE INDEX IF NOT EXISTS ix_trace_events_trace_seq ON trace_events (trace_id, id);
CREATE INDEX IF NOT EXISTS ix_trace_events_sk_ts ON trace_events (session_key, ts);
