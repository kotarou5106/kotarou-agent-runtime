...
logger = logging.getLogger("evaluation_system.personamem")


def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run PersonaMem benchmark against the kotarou agent runtime."
    )
...
async def _process_instance(
    ...
    *,
    ...
    from evaluation_system.longmemeval.ingest import ingest_instance
