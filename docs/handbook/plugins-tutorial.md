...
```python
from agent_runtime.plugins import Plugin, on_after_turn
from agent_runtime.lifecycle.types import AfterTurnCtx
...
```python
from agent_runtime.plugins import Plugin, on_tool_pre
from agent_runtime.lifecycle.types import PreToolCtx
from agent_runtime.tool_hooks import HookOutcome
...
```python
from agent_runtime.plugins import Plugin, tool
