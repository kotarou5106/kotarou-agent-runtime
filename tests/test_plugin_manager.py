...
from agent_runtime.core.passive_turn import ContextStore as _  # noqa: F401
from agent_runtime.lifecycle.types import AfterStepCtx, AfterToolResultCtx, BeforeToolCallCtx, BeforeTurnCtx
from agent_runtime.plugins.manager import PluginManager
from agent_runtime.plugins.registry import plugin_registry
...
from agent_runtime.core.memory.events import MemoryWritten, RetrievalCompleted, RetrievalHitSummary
...
async def test_tool_hooks_fire_through_real_reasoner():
    ...
    from agent_runtime.looping.ports import LLMConfig, LLMServices
...
async def test_on_tool_pre_rewrites_rm_to_mv():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        from agent_runtime.tool_hooks.types import ToolExecutionRequest
...
async def test_on_tool_pre_fires_through_real_reasoner():
    ...
    from agent_runtime.tools.base import Tool as AgentTool
