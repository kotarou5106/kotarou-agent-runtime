...
from agent_runtime.core.runtime_support import ToolDiscoveryState, TurnRunResult
from agent_runtime.provider import ContentSafetyError, ContextLengthError, LLMResponse
from agent_runtime.tools.shell import ShellTool, _MAX_OUTPUT, _truncate, _validate_network_command
from agent_runtime.tools.web_fetch import WebFetchTool, _to_markdown, _to_text, _validate_url_target
from memory_system.procedure_tagger import ProcedureTagger, _validate
from memory_system.store import MemoryStore2
from proactive_system.event import GenericContentEvent
...
async def test_reasoner_wrapper_and_shell_cover_branches(tmp_path: Path):
    ...
    with pytest.MonkeyPatch.context() as mp:
        mp.setattr("agent_runtime.tools.shell.asyncio.create_subprocess_shell", _fake_subprocess)
