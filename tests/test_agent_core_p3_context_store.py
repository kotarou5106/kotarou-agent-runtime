...
from agent_runtime.core.passive_turn import DefaultContextStore
from agent_runtime.core.types import RetrievalTrace
from agent_runtime.retrieval.protocol import RetrievalResult
...
async def test_default_context_store_prepare_returns_bundle_with_legacy_metadata():
    ...
    assert bundle.retrieval_metadata == {"source": "memory_system"}
