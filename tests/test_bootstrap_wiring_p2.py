...
from agent_runtime.config import Config, DEFAULT_SOCKET
from agent_runtime.config_models import Config as ConfigModel, WiringConfig
from agent_runtime.lifecycle.facade import TurnLifecycle
from agent_runtime.lifecycle.types import AfterStepCtx
...
""".strip()
    ...
    if sys.platform == "win32":
        assert cfg.channels.socket != "/tmp/toml-kotarou.sock"
