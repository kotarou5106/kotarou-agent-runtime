"""
tests/proactive_system/test_message_quality.py
...
from proactive_system.tools import _get_recent_chat
from tests.proactive_system.conftest import make_proactive_pipeline
