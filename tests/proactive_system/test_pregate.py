"""
TDD — Phase 4: proactive_system/ProactiveTurnPipeline — Pre-gate
...
from tests.proactive_system.conftest import (
    FakeLLM,
    FakeRng,
    FakeStateStore,
    cfg_with,
...
async def test_drift_interval_allows_after_window():
    ...
    from tests.proactive_system.conftest import FakeLLM
