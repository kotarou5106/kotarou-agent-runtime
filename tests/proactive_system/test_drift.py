...
from agent_runtime.prompting import is_context_frame
from agent_runtime.core.proactive_turn import ProactiveTurnPipeline, ProactiveTurnPipelineDeps
...
from agent_runtime.core.drift_turn import DriftTurnPipeline, DriftTurnPipelineDeps
from proactive_system.drift_state import DriftStateStore
from proactive_system.drift_tools import DriftToolDeps, build_drift_tool_registry
from proactive_system.agent_tick_factory import AgentTickDeps, AgentTickFactory
from proactive_system.gateway import GatewayDeps
from proactive_system.mcp_sources import McpClientPool
from proactive_system.tools import ToolDeps
from tests.proactive_system.conftest import FakeLLM, FakeRng, cfg_with, make_proactive_pipeline
