...
from memory_system.sufficiency_checker import SufficiencyChecker, SufficiencyResult
...
def test_should_check_when_no_items():
    from memory_system.sufficiency_checker import should_check_sufficiency
