...
from agent_runtime.events.events_lifecycle import ToolCallCompleted, ToolCallStarted
...
def test_default_reasoner_preflight_includes_deferred_tool_names():
    ...
    from agent_runtime.prompting import build_context_frame_content, build_context_frame_message
