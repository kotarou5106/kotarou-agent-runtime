...
import pytest
from agent_runtime.core.passive_support import collect_skill_mentions
from agent_runtime.core.passive_turn import DefaultReasoner
from agent_runtime.prompts.agent import build_current_message_time_envelope
import agent_runtime.looping.core as loop_core
from agent_runtime.looping.core import AgentLoop
from agent_runtime.looping.ports import AgentLoopConfig, AgentLoopDeps
from agent_runtime.core.memory.markdown import ConsolidateResult
